...
public:
  ...
  BlockType(bool _isSolid, bool _isBreakable, bool _isOpaque)
      : isSolid(_isSolid), isBreakable(_isBreakable), isOpaque(_isOpaque) {}

  virtual bool isDiagonal() { return false; }

  virtual bool isVisible() { return true; }

  virtual bool shouldBlend() { return false; }

  virtual glm::vec3 getMaterialSettings() {
    return glm::vec3(1.0f, // Minimum opacity (boolean)
                     2.0f, // Roughness
                     -1.0f // Specularity
    );
  }
...
public:
  ...
  std::string toString() override { return "Air"; }
};
...
public:
  ...
  std::string toString() override { return "Dirt"; }
};
...
public:
  ...
  std::string toString() override { return "Grass"; }
};
...
public:
  ...
  std::string toString() override { return "WoodLog"; }
};
...
public:
  ...
  std::string toString() override { return "WoodPlank"; }
};
...
public:
  ...
  std::string toString() override { return "Stone"; }
};
...
public:
  ...
  std::string toString() override { return "Cobblestone"; }
};
...
public:
  ...
  std::string toString() override { return "Sand"; }
};
...
public:
  ...
  std::string toString() override { return "Gravel"; }
};
...
public:
  ...
  std::string toString() override { return "Bedrock"; }
};
...
public:
  ...
  std::string toString() override { return "Leaves"; }
};
...
public:
  ...
  bool shouldBlend() override { return true; }

  glm::vec3 getMaterialSettings() override {
    return glm::vec3(0.0f,  // Minimum opacity (boolean)
                     0.3f,  // Roughness
                     200.0f // Specularity
    );
  }
  ...
  std::string toString() override { return "Water"; }
};
...
public:
  ...
  std::string toString() override { return "Bush"; }
};
...
public:
  ...
  std::string toString() override { return "BlackWool"; }
};
...
public:
  ...
  std::string toString() override { return "WhiteWool"; }
};
