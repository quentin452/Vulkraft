...
private:
  ...
  static void framebufferResizeCallback(GLFWwindow *window, int width,
                                        int height) {
    auto app = reinterpret_cast<VulkraftApplication *>(
  ...
  void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex,
    ...
    vkCmdBindVertexBuffers(commandBuffer, 0, 1, waterVertexBuffers,
                           waterOffsets);

    vkCmdBindIndexBuffer(commandBuffer, waterIndexBuffer[curBuffer], 0,
                         VK_INDEX_TYPE_UINT32);

    vkCmdDrawIndexed(commandBuffer, static_cast<uint32_t>(waterIndices.size()),
                     1, 0, 0, 0);
  ...
  void drawChunk(Chunk *newChunk) {
    ...
    waterVertices.insert(waterVertices.end(), curWaterVertices.begin(),
